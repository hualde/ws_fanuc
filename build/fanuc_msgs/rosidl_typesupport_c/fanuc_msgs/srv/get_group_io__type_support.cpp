...
static const _GetGroupIO_Request_type_support_symbol_names_t _GetGroupIO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetGroupIO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetGroupIO_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetGroupIO_Request)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetGroupIO_Request_message_type_support_handle;
}
...
static const _GetGroupIO_Response_type_support_symbol_names_t _GetGroupIO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetGroupIO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetGroupIO_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetGroupIO_Response)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetGroupIO_Response_message_type_support_handle;
}
...
static const _GetGroupIO_type_support_symbol_names_t _GetGroupIO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetGroupIO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetGroupIO)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetGroupIO)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetGroupIO_service_type_support_handle;
}
