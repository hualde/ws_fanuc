...
static const _GetAnalogIO_Request_type_support_symbol_names_t _GetAnalogIO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetAnalogIO_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetAnalogIO_Request)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetAnalogIO_Request_message_type_support_handle;
}
...
static const _GetAnalogIO_Response_type_support_symbol_names_t _GetAnalogIO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetAnalogIO_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetAnalogIO_Response)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetAnalogIO_Response_message_type_support_handle;
}
...
static const _GetAnalogIO_type_support_symbol_names_t _GetAnalogIO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, srv, GetAnalogIO)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, srv, GetAnalogIO)() {
  return &::fanuc_msgs::srv::rosidl_typesupport_c::GetAnalogIO_service_type_support_handle;
}
