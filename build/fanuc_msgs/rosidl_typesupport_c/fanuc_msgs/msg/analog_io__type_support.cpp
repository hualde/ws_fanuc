...
static const _AnalogIO_type_support_symbol_names_t _AnalogIO_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, msg, AnalogIO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fanuc_msgs, msg, AnalogIO)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fanuc_msgs, msg, AnalogIO)() {
  return &::fanuc_msgs::msg::rosidl_typesupport_c::AnalogIO_message_type_support_handle;
}
