...
class Metaclass_GetPosReg_Request(type):
    """Metaclass of message 'GetPosReg_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_pos_reg__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_pos_reg__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_pos_reg__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_pos_reg__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_pos_reg__request
...
class GetPosReg_Request(metaclass=Metaclass_GetPosReg_Request):
    """Message class 'GetPosReg_Request'."""
...
class Metaclass_GetPosReg_Response(type):
    """Metaclass of message 'GetPosReg_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_pos_reg__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_pos_reg__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_pos_reg__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_pos_reg__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_pos_reg__response
...
class GetPosReg_Response(metaclass=Metaclass_GetPosReg_Response):
    """Message class 'GetPosReg_Response'."""
...
class Metaclass_GetPosReg(type):
    """Metaclass of service 'GetPosReg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'fanuc_msgs.srv.GetPosReg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__get_pos_reg

            from fanuc_msgs.srv import _get_pos_reg
            if _get_pos_reg.Metaclass_GetPosReg_Request._TYPE_SUPPORT is None:
                _get_pos_reg.Metaclass_GetPosReg_Request.__import_type_support__()
            if _get_pos_reg.Metaclass_GetPosReg_Response._TYPE_SUPPORT is None:
                _get_pos_reg.Metaclass_GetPosReg_Response.__import_type_support__()


class GetPosReg(metaclass=Metaclass_GetPosReg):
    from fanuc_msgs.srv._get_pos_reg import GetPosReg_Request as Request
    from fanuc_msgs.srv._get_pos_reg import GetPosReg_Response as Response
