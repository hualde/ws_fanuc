...
class Metaclass_SetAnalogIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from fanuc_msgs.srv import _set_analog_io
...
class SetAnalogIO(metaclass=Metaclass_SetAnalogIO):
    from fanuc_msgs.srv._set_analog_io import SetAnalogIO_Request as Request
    from fanuc_msgs.srv._set_analog_io import SetAnalogIO_Response as Response
