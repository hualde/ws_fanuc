...
bool fanuc_msgs__srv__get_pos_reg__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.srv._get_pos_reg.GetPosReg_Request", full_classname_dest, 45) == 0);
  }
  fanuc_msgs__srv__GetPosReg_Request * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of GetPosReg_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.srv._get_pos_reg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPosReg_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool fanuc_msgs__srv__get_pos_reg__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.srv._get_pos_reg.GetPosReg_Response", full_classname_dest, 46) == 0);
  }
  fanuc_msgs__srv__GetPosReg_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of GetPosReg_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.srv._get_pos_reg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPosReg_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
