...
bool fanuc_msgs__msg__analog_io__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.msg._analog_io.AnalogIO", full_classname_dest, 34) == 0);
  }
  fanuc_msgs__msg__AnalogIO * ros_message = _ros_message;
  {  // io_type
...
PyObject * fanuc_msgs__msg__analog_io__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.msg._analog_io");
