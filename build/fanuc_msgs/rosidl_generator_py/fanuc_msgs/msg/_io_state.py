...
class Metaclass_IOState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from fanuc_msgs.msg import BoolIO
            if BoolIO.__class__._TYPE_SUPPORT is None:
                BoolIO.__class__.__import_type_support__()
...
class IOState(metaclass=Metaclass_IOState):
    ...
    _fields_and_field_types = {
        'values': 'sequence<fanuc_msgs/BoolIO>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['fanuc_msgs', 'msg'], 'BoolIO')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, BoolIO) for v in value) and
                 True), \
                "The 'values' field must be a set or sequence and each value of type 'BoolIO'"
        self._values = value
