...
bool fanuc_msgs__msg__io_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.msg._io_type.IOType", full_classname_dest, 30) == 0);
  }
  fanuc_msgs__msg__IOType * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of IOType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.msg._io_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IOType");
