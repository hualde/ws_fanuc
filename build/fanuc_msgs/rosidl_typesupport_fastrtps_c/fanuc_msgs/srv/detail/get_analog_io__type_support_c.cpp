...
#include "fanuc_msgs/srv/detail/get_analog_io__rosidl_typesupport_fastrtps_c.h"
...
using _GetAnalogIO_Request__ros_msg_type = fanuc_msgs__srv__GetAnalogIO_Request;
...
size_t get_serialized_size_fanuc_msgs__srv__GetAnalogIO_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetAnalogIO_Request__ros_msg_type * ros_message = static_cast<const _GetAnalogIO_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GetAnalogIO_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fanuc_msgs__srv__GetAnalogIO_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fanuc_msgs
size_t max_serialized_size_fanuc_msgs__srv__GetAnalogIO_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fanuc_msgs__srv__GetAnalogIO_Request;
    is_plain =
      (
...
static size_t _GetAnalogIO_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fanuc_msgs__srv__GetAnalogIO_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO_Request)() {
...
using _GetAnalogIO_Response__ros_msg_type = fanuc_msgs__srv__GetAnalogIO_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fanuc_msgs
size_t get_serialized_size_fanuc_msgs__srv__GetAnalogIO_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetAnalogIO_Response__ros_msg_type * ros_message = static_cast<const _GetAnalogIO_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fanuc_msgs__srv__GetAnalogIO_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fanuc_msgs
size_t max_serialized_size_fanuc_msgs__srv__GetAnalogIO_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fanuc_msgs__srv__GetAnalogIO_Response;
    is_plain =
      (
...
static size_t _GetAnalogIO_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fanuc_msgs__srv__GetAnalogIO_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO_Response)() {
...
// already included above
// #include "fanuc_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "fanuc_msgs/srv/get_analog_io.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, srv, GetAnalogIO)() {
