...
#include "fanuc_msgs/msg/detail/io_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _IOCmd__ros_msg_type = fanuc_msgs__msg__IOCmd;
...
size_t get_serialized_size_fanuc_msgs__msg__IOCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IOCmd__ros_msg_type * ros_message = static_cast<const _IOCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IOCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fanuc_msgs__msg__IOCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fanuc_msgs
size_t max_serialized_size_fanuc_msgs__msg__IOCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fanuc_msgs__msg__IOCmd;
    is_plain =
      (
...
static size_t _IOCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fanuc_msgs__msg__IOCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, msg, IOCmd)() {
