...
#include "fanuc_msgs/msg/detail/io_state__rosidl_typesupport_fastrtps_c.h"
...
#include "fanuc_msgs/msg/detail/bool_io__functions.h"  // values
...
using _IOState__ros_msg_type = fanuc_msgs__msg__IOState;
  ...
  // Field name: values
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fanuc_msgs, msg, BoolIO
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: values
  {
    ...
    if (ros_message->values.data) {
      fanuc_msgs__msg__BoolIO__Sequence__fini(&ros_message->values);
    }
    if (!fanuc_msgs__msg__BoolIO__Sequence__init(&ros_message->values, size)) {
...
size_t get_serialized_size_fanuc_msgs__msg__IOState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IOState__ros_msg_type * ros_message = static_cast<const _IOState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_fanuc_msgs__msg__BoolIO(
...
static uint32_t _IOState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fanuc_msgs__msg__IOState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fanuc_msgs
size_t max_serialized_size_fanuc_msgs__msg__IOState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_fanuc_msgs__msg__BoolIO(
  ...
  if (is_plain) {
    ...
    using DataType = fanuc_msgs__msg__IOState;
    is_plain =
      (
...
static size_t _IOState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fanuc_msgs__msg__IOState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fanuc_msgs, msg, IOState)() {
