...
#include "fanuc_msgs/msg/detail/io_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fanuc_msgs::msg::IOCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fanuc_msgs::msg::IOCmd & ros_message)
{
  // Member: values
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fanuc_msgs::msg::IOCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fanuc_msgs::msg::IOCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fanuc_msgs::msg::IOCmd *>(
    untyped_ros_message);
...
{
  return &fanuc_msgs::msg::typesupport_fastrtps_cpp::_IOCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fanuc_msgs, msg, IOCmd)() {
  return &fanuc_msgs::msg::typesupport_fastrtps_cpp::_IOCmd__handle;
}
