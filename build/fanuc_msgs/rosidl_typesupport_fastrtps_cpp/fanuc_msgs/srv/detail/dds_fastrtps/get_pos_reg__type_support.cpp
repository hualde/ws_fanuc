...
#include "fanuc_msgs/srv/detail/get_pos_reg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fanuc_msgs::srv::GetPosReg_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fanuc_msgs::srv::GetPosReg_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fanuc_msgs::srv::GetPosReg_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetPosReg_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fanuc_msgs::srv::GetPosReg_Request *>(
...
static size_t _GetPosReg_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPosReg_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetPosReg_Request__callbacks = {
  "fanuc_msgs::srv",
  "GetPosReg_Request",
...
static rosidl_message_type_support_t _GetPosReg_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPosReg_Request__callbacks,
...
{
  return &fanuc_msgs::srv::typesupport_fastrtps_cpp::_GetPosReg_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fanuc_msgs::srv::GetPosReg_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fanuc_msgs::srv::GetPosReg_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fanuc_msgs::srv::GetPosReg_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetPosReg_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fanuc_msgs::srv::GetPosReg_Response *>(
...
static size_t _GetPosReg_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPosReg_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetPosReg_Response__callbacks = {
  "fanuc_msgs::srv",
  "GetPosReg_Response",
...
static rosidl_message_type_support_t _GetPosReg_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPosReg_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &fanuc_msgs::srv::typesupport_fastrtps_cpp::_GetPosReg_Response__handle;
}
...
static service_type_support_callbacks_t _GetPosReg__callbacks = {
  "fanuc_msgs::srv",
  "GetPosReg",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fanuc_msgs, srv, GetPosReg_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fanuc_msgs, srv, GetPosReg_Response)(),
...
static rosidl_service_type_support_t _GetPosReg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPosReg__callbacks,
...
{
  return &fanuc_msgs::srv::typesupport_fastrtps_cpp::_GetPosReg__handle;
}
