...
#ifndef FANUC_MSGS__SRV__DETAIL__SET_NUM_REG__FUNCTIONS_H_
#define FANUC_MSGS__SRV__DETAIL__SET_NUM_REG__FUNCTIONS_H_
...
/// Initialize srv/SetNumReg message.
/**
...
/// Finalize srv/SetNumReg message.
/**
...
/// Create srv/SetNumReg message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fanuc_msgs__srv__SetNumReg_Request__init().
...
/// Destroy srv/SetNumReg message.
/**
 * It calls
 * fanuc_msgs__srv__SetNumReg_Request__fini()
...
/// Check for srv/SetNumReg message equality.
/**
...
/// Initialize array of srv/SetNumReg messages.
/**
...
/// Finalize array of srv/SetNumReg messages.
/**
 * It calls
 * fanuc_msgs__srv__SetNumReg_Request__fini()
...
/// Create array of srv/SetNumReg messages.
/**
 * It allocates the memory for the array and calls
 * fanuc_msgs__srv__SetNumReg_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetNumReg messages.
/**
 * It calls
 * fanuc_msgs__srv__SetNumReg_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetNumReg message array equality.
/**
...
/// Copy an array of srv/SetNumReg messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fanuc_msgs__srv__SetNumReg_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fanuc_msgs
...
/**
 * It calls
 * fanuc_msgs__srv__SetNumReg_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fanuc_msgs
...
/**
 * It allocates the memory for the array and calls
 * fanuc_msgs__srv__SetNumReg_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fanuc_msgs
...
/**
 * It calls
 * fanuc_msgs__srv__SetNumReg_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FANUC_MSGS__SRV__DETAIL__SET_NUM_REG__FUNCTIONS_H_
