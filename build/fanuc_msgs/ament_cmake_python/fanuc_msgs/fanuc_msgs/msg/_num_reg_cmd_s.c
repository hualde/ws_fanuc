...
bool fanuc_msgs__msg__num_reg_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.msg._num_reg_cmd.NumRegCmd", full_classname_dest, 37) == 0);
  }
  fanuc_msgs__msg__NumRegCmd * ros_message = _ros_message;
  {  // values
...
{
  /* NOTE(esteve): Call constructor of NumRegCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.msg._num_reg_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NumRegCmd");
