...
fanuc_msgs__msg__NumRegState__init(fanuc_msgs__msg__NumRegState * msg)
{
  ...
  // values
  if (!fanuc_msgs__msg__NumReg__Sequence__init(&msg->values, 0)) {
    fanuc_msgs__msg__NumRegState__fini(msg);
    return false;
  }
  return true;
}
...
fanuc_msgs__msg__NumRegState__fini(fanuc_msgs__msg__NumRegState * msg)
{
  ...
  // values
  fanuc_msgs__msg__NumReg__Sequence__fini(&msg->values);
}
...
fanuc_msgs__msg__NumRegState__are_equal(const fanuc_msgs__msg__NumRegState * lhs, const fanuc_msgs__msg__NumRegState * rhs)
{
  ...
  // values
  if (!fanuc_msgs__msg__NumReg__Sequence__are_equal(
  ...
  fanuc_msgs__msg__NumRegState * output)
{
  ...
  // values
  if (!fanuc_msgs__msg__NumReg__Sequence__copy(
...
fanuc_msgs__msg__NumRegState__create()
{
  ...
  fanuc_msgs__msg__NumRegState * msg = (fanuc_msgs__msg__NumRegState *)allocator.allocate(sizeof(fanuc_msgs__msg__NumRegState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fanuc_msgs__msg__NumRegState));
  bool success = fanuc_msgs__msg__NumRegState__init(msg);
  if (!success) {
...
fanuc_msgs__msg__NumRegState__Sequence__init(fanuc_msgs__msg__NumRegState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fanuc_msgs__msg__NumRegState * data = NULL;

  if (size) {
    data = (fanuc_msgs__msg__NumRegState *)allocator.zero_allocate(size, sizeof(fanuc_msgs__msg__NumRegState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fanuc_msgs__msg__NumRegState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        fanuc_msgs__msg__NumRegState__fini(&data[i - 1]);
      }
...
fanuc_msgs__msg__NumRegState__Sequence__fini(fanuc_msgs__msg__NumRegState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      fanuc_msgs__msg__NumRegState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fanuc_msgs__msg__NumRegState__Sequence * array = (fanuc_msgs__msg__NumRegState__Sequence *)allocator.allocate(sizeof(fanuc_msgs__msg__NumRegState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fanuc_msgs__msg__NumRegState__Sequence__init(array, size);
  if (!success) {
...
fanuc_msgs__msg__NumRegState__Sequence__destroy(fanuc_msgs__msg__NumRegState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fanuc_msgs__msg__NumRegState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fanuc_msgs__msg__NumRegState__Sequence__are_equal(const fanuc_msgs__msg__NumRegState__Sequence * lhs, const fanuc_msgs__msg__NumRegState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fanuc_msgs__msg__NumRegState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fanuc_msgs__msg__NumRegState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fanuc_msgs__msg__NumRegState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fanuc_msgs__msg__NumRegState * data =
      (fanuc_msgs__msg__NumRegState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fanuc_msgs__msg__NumRegState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fanuc_msgs__msg__NumRegState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!fanuc_msgs__msg__NumRegState__copy(
