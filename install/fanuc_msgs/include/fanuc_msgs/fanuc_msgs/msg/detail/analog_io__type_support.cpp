...
{
  new (message_memory) fanuc_msgs::msg::AnalogIO(_init);
}

void AnalogIO_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fanuc_msgs::msg::AnalogIO *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AnalogIO_message_member_array[3] = {
  {
    ...
    offsetof(fanuc_msgs::msg::AnalogIO, io_type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fanuc_msgs::msg::AnalogIO, index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fanuc_msgs::msg::AnalogIO, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AnalogIO_message_members = {
  ...
  3,  // number of fields
  sizeof(fanuc_msgs::msg::AnalogIO),
...
{
  return &::fanuc_msgs::msg::rosidl_typesupport_introspection_cpp::AnalogIO_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fanuc_msgs, msg, AnalogIO)() {
  return &::fanuc_msgs::msg::rosidl_typesupport_introspection_cpp::AnalogIO_message_type_support_handle;
}
