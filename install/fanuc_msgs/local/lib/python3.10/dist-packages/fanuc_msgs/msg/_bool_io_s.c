...
bool fanuc_msgs__msg__bool_io__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.msg._bool_io.BoolIO", full_classname_dest, 30) == 0);
  }
  fanuc_msgs__msg__BoolIO * ros_message = _ros_message;
  {  // io_type
...
{
  /* NOTE(esteve): Call constructor of BoolIO */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.msg._bool_io");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoolIO");
