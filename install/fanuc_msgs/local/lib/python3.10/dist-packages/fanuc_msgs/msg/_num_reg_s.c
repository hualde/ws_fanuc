...
bool fanuc_msgs__msg__num_reg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.msg._num_reg.NumReg", full_classname_dest, 30) == 0);
  }
  fanuc_msgs__msg__NumReg * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of NumReg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.msg._num_reg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NumReg");
