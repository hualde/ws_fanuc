...
bool fanuc_msgs__srv__set_payload_value__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.srv._set_payload_value.SetPayloadValue_Request", full_classname_dest, 57) == 0);
  }
  fanuc_msgs__srv__SetPayloadValue_Request * ros_message = _ros_message;
  {  // payload_schedule_id
  ...
  {  // use_in
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_in");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_in = (Py_True == field);
    Py_DECREF(field);
  }
  {  // in_x
...
{
  /* NOTE(esteve): Call constructor of SetPayloadValue_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.srv._set_payload_value");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPayloadValue_Request");
  ...
  {  // use_in
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_in ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_in", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool fanuc_msgs__srv__set_payload_value__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fanuc_msgs.srv._set_payload_value.SetPayloadValue_Response", full_classname_dest, 58) == 0);
  }
  fanuc_msgs__srv__SetPayloadValue_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of SetPayloadValue_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fanuc_msgs.srv._set_payload_value");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPayloadValue_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
